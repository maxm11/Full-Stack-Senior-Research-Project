...
function init_charts() {
    ...
    if ($('#canvasRadarPhysical').length) {

        var ctx = document.getElementById("canvasRadarPhysical");
        var data = {
            labels: ["Sickness", "Tired", "Hunger", "Thirst"],
            datasets: [{
        ...
        var canvasRadarPhysical = new Chart(ctx, {
            type: 'radar',
            data: data,
        });
