...
urlpatterns = [
    ...
    path('entity/<int:entity_id>/data/', views.entityChartData, name='entityChartData'),
    ...
    path('entity/<int:entity_id>/experience/<int:exp_id>/delete', views.deleteExperience, name='deleteExperience'),
